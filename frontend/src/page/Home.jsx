...
const Home = () => {
  ...
  <h1 className='text-3xl font-bold mx-auto'>
    MANAGE YOUR CONTACTS <br /> WITH <span className='text-[#22c55e]'>CONTACT BOOK</span>
  </h1>
  <p className='text-lg mx-auto mt-4 w-[30rem]'>
  ...
  <button className="home-btn mt-6">See Contacts</button>
</div>
